...
const About = () => (
  <section id="about" className="min-h-screen py-24 px-8 md:px-12 lg:px-20 relative flex items-center">
    <div className="container mx-auto">
      <motion.h2 
        initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}
        className="text-4xl md:text-6xl italic text-[#F5F5DC] mt-6 -mb-6"
      >
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        ...
        <motion.div 
          ...
          className="aspect-[1/1] md:aspect-square bg-[#F5F5DC]/5 rounded-2xl border border-[#F5F5DC]/10 relative overflow-hidden group"
        >
