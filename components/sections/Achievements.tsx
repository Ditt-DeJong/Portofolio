        ...
        {DATA.achievements.map((item, i) => (
          ...
          >
            ...
            <div className="flex items-center gap-4 self-end md:self-auto">
               ...
               <ArrowRight className="w-5 h-5 text-[#F5F5DC]/0 group-hover:text-[#F5F5DC] transition-all opacity-0 group-hover:opacity-100 hidden md:block" />
               {/* Mobile arrow always visible or maybe just hidden on mobile to screen estate? Let's keep consistency */}
